...
contract LPGenesisPool is LPTokenWrapper, Ownable {
    ...
    constructor(ERC1155Tradable _gokusAddress, IERC20 _erc20Address) public LPTokenWrapper(_erc20Address) {
        gokus = _gokusAddress;
    }
    ...
    function earned(address account) public view returns (uint256) {
        ...
        return
        points[account].add(
            blockTime.sub(lastUpdateTime[account]).div(86400).mul(
                (balanceOf(account).mul(250))
            )
        );
    }
